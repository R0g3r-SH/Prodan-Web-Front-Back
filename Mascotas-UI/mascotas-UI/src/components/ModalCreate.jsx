...
const ModalCreate = ({ open, onClose, title, frases, setFrases, res, setres, nq, setloading, setdata }) => {
    ...
    const fetchdata3 = async (nq, frases, res) => {
        const res2 = await axios.post(`http://localhost:5000/create`, { id: nq, name: name, traning: frases, newmsg: [res] });
    };

    const handleSave = () => {
        setloading(true)
        fetchdata3(nq, frases, res).then(() => {
            onClose()
            setTimeout(() => {
                fetchdata().then(() => {
                    setTimeout(() => {
            ...
            <div className="modal-card">
                ...
                <section className="modal-card-body">
                    ...
                    <div className="modaler">
                        ...
                        <input  className="input" type="text" onChange={e=>setname(e.currentTarget.value)} />
